...
function combine() {
  ...
  for (var pi of out_img.values()) {
    ...
    var r2 = bg_img.getPixel(pi.getX(),pi.getY()).getRed();
    var g2 = bg_img.getPixel(pi.getX(),pi.getY()).getGreen();
    var b2 = bg_img.getPixel(pi.getX(),pi.getY()).getBlue();
